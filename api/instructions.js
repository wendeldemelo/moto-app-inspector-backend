export default async function handler(request, response) {
    ...
    try {
        ...
        const prompt = `You are AI Assistant, an expert in Android security and performance for Android devices.
...
4. Do not mention technical terms like "SDK" or "API Level" to the user, translate it to "optimization version".`;
        ...
        return response.status(500).json({ 
            instructions: "We were unable to load the AI ​​instructions at this time. We recommend manually checking the app's configuration in your system settings." 
        });
    }
}
